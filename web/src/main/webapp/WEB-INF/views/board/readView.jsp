...
<body>
	...
	<div>
	 ...
	 -->
		...
		<div>
			...
			<textarea id="name" name="name" placeholder="작성자" readonly="readonly">${boardVO.name}</textarea>
		</div>		
	...
	<form name="replyForm" method="post">
	  ...
	  <div>
	    ...
	    <input type="text" id="replyer" name="replyer" value="${user.identification}" readonly="readonly"/>
	    <br/>
